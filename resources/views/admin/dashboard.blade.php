        ...
        <div class="card">
            ...
            <div class="card-body">
                @if(count($statusCounts) > 0)
                    <div style="max-height: 280px; max-width: 100%; display: flex; justify-content: center; align-items: center;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        @if($monthlyCritiques->count() > 0)
            ...
            const trendLabels = {!! json_encode($monthlyCritiques->map(function($item) {
