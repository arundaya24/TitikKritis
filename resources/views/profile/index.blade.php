    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    <div class="profile-image mx-auto" style="width: 80px; height: 80px; font-size: 2.5rem; background-color: #0d6efd; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="regency_id" name="regency_id" required>
                                    ...
                                    @foreach($regencies as $regency)
                                        <option value="{{ $regency->id }}" {{ $user->regency_id == $regency->id ? 'selected' : '' }}>
                                            {{ $regency->name }}
                                        </option>
                                    @endforeach
                                </select>
